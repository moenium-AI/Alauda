...
## Licence selected for Alauda

Alauda uses JUCE 9.0.1 under the JUCE 9 Starter licence. The Starter
licence is a JUCE licence type and applies only to Alauda's use of the
JUCE Framework; it does not change the licence for Alauda itself or for
...
## Components included through Alauda's JUCE build

Alauda uses the five JUCE modules listed in
[`third_party/JUCE/ALAUDA_INTEGRATION.md`](../third_party/JUCE/ALAUDA_INTEGRATION.md).
The Windows JUCE GUI project also compiles the following embedded components:

| Component | Licence | Vendored notice |
| --- | --- | --- |
| zlib | zlib License | [`zlib/LICENSE`](../third_party/JUCE/modules/juce_core/zip/zlib/LICENSE) |
| libpng | PNG Reference Library License | [`pnglib/LICENSE`](../third_party/JUCE/modules/juce_graphics/image_formats/pnglib/LICENSE) |
| Independent JPEG Group JPEG software | IJG license | [`jpglib/README`](../third_party/JUCE/modules/juce_graphics/image_formats/jpglib/README) |
| HarfBuzz | Old MIT license | [`harfbuzz/COPYING`](../third_party/JUCE/modules/juce_graphics/fonts/harfbuzz/COPYING) |
| SheenBidi | Apache License 2.0 | [`sheenbidi/LICENSE`](../third_party/JUCE/modules/juce_graphics/unicode/sheenbidi/LICENSE) |
| LunaSVG | MIT License | [`lunasvg/LICENSE`](../third_party/JUCE/modules/juce_graphics/drawables/lunasvg/LICENSE) |
| PlutoVG | MIT License | [`plutovg/LICENSE`](../third_party/JUCE/modules/juce_graphics/drawables/lunasvg/plutovg/LICENSE) |

These notices are part of the vendored JUCE source tree and are separate from
Alauda's own licence. In particular, the accompanying documentation includes
...
Box2D, and ASIO. Those modules are not vendored or built by Alauda. The Windows
